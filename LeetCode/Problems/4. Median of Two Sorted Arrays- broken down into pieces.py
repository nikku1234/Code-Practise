class Solution(object):
    def findMedianSortedArrays(self, nums1, nums2):
        ...
        """
        '''
        Finding a pivot point, where all elements to the left are smaller and all elements to the right are larger
        ...
        '''
        #get value at index at i for arr(array)
        def getVal(arr, i):
            if i == -1:
                return float('-inf')
            if i == len(arr):
